...
epicsEnvSet("LOCATION", "PLC:VLS:MOTION" )
...
epicsEnvSet("IPADDR",           "5.58.198.222")
epicsEnvSet("AMSID",            "5.58.198.222.1.1")
...
epicsEnvSet("PREFIX",         "PLC:VLS:MOTION:")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "SR")
epicsEnvSet("DESC",            "Main.M1 / VLS-Slit-Right")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "SL")
epicsEnvSet("DESC",            "Main.M2 / VLS-Slit-Left")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "SD")
epicsEnvSet("DESC",            "Main.M3 / VLS-Slit-Down")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "pv: TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "SU")
epicsEnvSet("DESC",            "Main.M4 / VLS-Slit-Up")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "FM")
epicsEnvSet("DESC",            "Main.M5 / VLS-Focus-Mirror")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("DESC",            "Main.M6 / VLS-Grating")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CD")
epicsEnvSet("DESC",            "Main.M7 / VLS-Camera-Dist")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:VLS:MMS:")
epicsEnvSet("MOTOR_NAME",      "CP")
epicsEnvSet("DESC",            "Main.M8 / VLS-Camera-Pitch")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:VLS:MOTION")
dbLoadRecords("save_restoreStatus.db", "P=PLC:VLS:MOTION:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:VLS:MOTION")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:VLS:MOTION")
...
save_restoreSet_status_prefix( "PLC:VLS:MOTION:" )
